    ...
    return (
        <div className='container d-flex' style={{ paddingTop:'10%' }} id="home">
            <div className='col-md-6'>
                ...
                <div>
                    <a href="#features" class="btn btn-outline-primary rounded-pill p-2"><small>SEE FEATURES</small></a>
                    <a href="#price" class="btn btn-outline-primary mx-2 rounded-pill p-2"><small>PRICING</small></a>
                </div>
            </div>
